...
abstract class Zend_Service_Facebook_Methods
{
     ...
     *
     * @param string $url
     *            url (can be relative, default graph api)
     * @param array $args
     *            arguments to the call
     * @param string $http_method
     *            which REST api method to call
     * @return object results of call
     */
    public function makeRequest($url, $args = array(), $http_method = Zend_Http_Client::GET, $files = array())
    {
        return $this->_core->getClient()->makeRequest($url, $args, $http_method, $files);
    }
}
